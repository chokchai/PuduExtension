...
(function() {
  ...
  $menuMore.append('<td align="center" class="navigation"><a href="userdetails.php?id=' + pudu.getCookie('xid') + '">User</a></td>', $menu.find('a[href="oforums.php"]').parent(), '<td align="center" colspan="2" class="navigation"><a href="userhistory.php?action=viewnewposts&id=' + pudu.getCookie('xid') + '">Forums History</a></td>', '<td align="center" class="navigation"><a href="userhistory.php?action=viewmarkets&id=' + pudu.getCookie('xid') + '">Markets History</a></td>', $menu.find('a[href="pets.php"]').parent(), '<td align="center" class="navigation"><a href="bookmark.php">Bookmark</a></td>', $menu.find('a[href="arena.php"]').parent(), '<td align="center" class="navigation" colspan="2"><a href="users.php">Search Users</a></td>', $menu.find('a[href="casino.php"]').parent(), $menu.find('a[href="chat.php"]').parent());
  ...
  if (page.viewtopic) {
    ...
    pudu.isOptionEnable('hideSignature', function() {
      return $commentsContent.each(function() {
        var cIndex, html;
        html = $(this).html();
    ...
    pudu.getOptionBoolean('hideCommentNumber', function(enable) {
      return $commentsBox.each(function() {
        var $html, html, name;
        name = $(this).attr('name');
        if (name === 'last') {
        ...
        html = $header.html().replace(' GMT', '').replace(/\[/g, '').replace(/\]/g, '').replace('--', '-');
        if (enable === true) {
    ...
    $('body').append('<div id="pudu-comment-button" class="hide">\
    ...
    $cBtn.on('click', function() {
      return $('html, body').animate({
        scrollTop: $('#pudu-quick-comment').offset().top
      }, 300);
    });
    $(window).on('scroll', function() {
      ...
      sd = $(window).scrollTop();
      if (sd > 200) {
        return $cBtn.fadeIn(100);
      } else {
        return $cBtn.fadeOut(100);
      }
    });
  }
  ...
  if (page.newtopic) {
    ...
    $textarea.css({
      width: '100%'
    }).attr('id', "" + id + "-textarea").before(emoHtml[0]).after(emoHtml[1]);
  }
